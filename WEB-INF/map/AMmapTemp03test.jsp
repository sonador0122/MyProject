...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/Eden/common/css/ammap/ammap.css" type="text/css">
        <script src="/Eden/common/js/ammap/ammap.js" type="text/javascript"></script>
        <!-- map file should be inclded after ammap.js -->
		<script src="/Eden/common/js/ammap/maps/worldLow.js" type="text/javascript"></script>
		<script src="/Eden/common/js/ammap/themes/light.js" type="text/javascript"></script>
		...
		var mapData = [
			...
			{"code":"KR" , "name":"Korea, Dem. Rep.", "value":24451285},
			{"code":"KP" , "name":"Korea, Rep.", "value":48391343},
			...
			AmCharts.ready(function() {
				...
				map.pathToImages = "/Eden/common/Ammap-images/";
				map.addTitle("Eden project ", 20);
				map.areasSettings = {
					unlistedAreasColor:  "#8D725F",
    		 ...
    		 <%String[] ISO = (String[])request.getAttribute("ISO");
			System.out.println(ISO[0]);
			int isosize = ISO.length;
			System.out.println(isosize);
			%>
		
			 	for(var i=0; i<mapData.length; i++){
					/* alert("mapData.length====="+mapData.length); */
